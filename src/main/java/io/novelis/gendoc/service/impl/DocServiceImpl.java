...
public class DocServiceImpl implements DocService {
    ...
    public File generateDoc(DocDTO docDTO){
        ...
        String INPUT_DIR = "src/main/resources/velocity-templates/";
        ...
        try {
            ...
            save(docDTO);
        } catch (XDocReportException | IOException xdoce) {
    ...
    public File convertDOCXToPDF(File docxFile, String docType) {
        ...
        try {
            ...
            String OUTPUT_DIR = "src/main/resources/generated-documents/";
