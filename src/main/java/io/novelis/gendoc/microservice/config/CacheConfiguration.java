package io.novelis.gendoc.microservice.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.getMapConfigs().put("io.novelis.gendoc.microservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
